...
video_w = cv2.VideoWriter("traffic_tilt.avi",fourcc , video_r.get(cv2.CAP_PROP_FPS), (int(video_r.get(cv2.CAP_PROP_FRAME_HEIGHT)),int(video_r.get(cv2.CAP_PROP_FRAME_WIDTH))))
